...
def main() -> int:
    ...
    parser.add_argument("--tone", action="store_true", help="Send continuous test tone")
    parser.add_argument("--freq", type=int, default=None, help="Carrier frequency in Hz")
    parser.add_argument("--gain", type=int, default=None, help="TX gain in dB")
    parser.add_argument("--simulation", action="store_true", help="Run in simulation mode")
    args = parser.parse_args()

    config = load_config()
    freq = args.freq or config.radio.center_frequency
    gain = args.gain or config.radio.tx_gain
