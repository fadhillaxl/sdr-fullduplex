...
class StartLinkRequest(BaseModel):
    ...
    tx_freq: Optional[int] = Field(None, description="Explicit TX carrier frequency override in Hz")
    rx_freq: Optional[int] = Field(None, description="Explicit RX carrier frequency override in Hz")
